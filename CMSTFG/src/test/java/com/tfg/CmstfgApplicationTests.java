...
//	    assertEquals (producto4, productoDevuelto4);
	...
	Historico_precios historico = new Historico_precios(LocalDateTime.now(), productoPrueba, productoPrueba.getPrecio());
	...
	Historico_precios historicoBuscado = historicoService.findCurrentPrice(historicoDev3.getId());
